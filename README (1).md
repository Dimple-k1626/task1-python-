...
This program performs **Addition, Subtraction, Multiplication, and
Division** with proper input validation and error handling.
...
The program then prints the result using the corresponding function.
...
## 📘 Functions Overview
  ...
  `divide(a, b)`                Performs division and handles
                                divide-by-zero

  `calculator()`                Main loop displaying menu and collecting
                                user inputs
  -----------------------------------------------------------------------
